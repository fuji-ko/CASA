...
This project contains the dataset  and baseline multimodal classification models described by [Paper](https://arxiv.org/abs/2506.00644) Refer  [Annotation Guidline](docs/guidlines.md) to see the details of the annotaion guidlines. The annotations are located in the `data/Voices-AWS` folder
